...
class Sketch_Data(datasets.ImageFolder):

    def __init__(self, root='data', split='train'):
        super(Sketch_Data, self).__init__(root)
        ...
        self.split = split
        if self.split == 'train':
            self.labels_loc = os.path.join(root, 'sketchPath_process_train.csv')
            # self.labels_loc = os.path.join(root, 'sketchPath_sample_train.csv')
            self.transform = data_transforms['train']
        else:
            self.labels_loc = os.path.join(root, 'sketchPath_process_test.csv')
            # self.labels_loc = os.path.join(root, 'sketchPath_sample_test.csv')
